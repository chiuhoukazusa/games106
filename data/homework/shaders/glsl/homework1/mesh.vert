...
layout(set=2, binding=0) readonly buffer SkeletonMatrices{
	mat4 sm[];
};
...
void main() 
{
	...
	outPos = worldPos;
	outViewVec = uboScene.viewPos.xyz - worldPos.xyz;
	outLightVec = uboScene.lightPos.xzy - worldPos.xyz;
}